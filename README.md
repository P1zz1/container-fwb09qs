...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fwb09qs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fwb09qs.containers.anotherwebservice.com/
...
```
git clone git@github.com:P1zz1/container-fwb09qs.git
cd container-fwb09qs
```
...
```
docker attach container-fwb09qs
```
